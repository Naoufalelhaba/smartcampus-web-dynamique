-- =====================================================================
--  SmartCampus — Jeu de données de démonstration
...
--  (les valeurs ci-dessous sont les hachés bcrypt correspondants)
--
--  Les identifiants (idUser, idCours...) sont fixés explicitement pour que
--  les associations (inscriptions, notes, séances) soient sans ambiguïté.
-- =====================================================================
USE smartcampus;
...
-- 4 enseignants (mot de passe : prof123)
INSERT INTO Utilisateur (idUser, nom, prenom, email, mot_de_passe, role, promotion) VALUES
...
-- 10 étudiants répartis sur les 3 promotions (mot de passe : etudiant123)
INSERT INTO Utilisateur (idUser, nom, prenom, email, mot_de_passe, role, promotion) VALUES
...
-- ---------- Cours ----------
-- Le cours 3 (Algorithmique) a capaciteMax = 2 : il servira à démontrer la règle R2 (cours complet).
...
-- ---------- Inscriptions ----------
-- Cours 3 (capacite 2) est volontairement REMPLI (Lea + Nathan) -> inscrire un 3e etudiant sera bloque.
INSERT INTO Inscription (idEtudiant, idCours) VALUES
-- ING2 -> cours ING2
(9, 1), (10, 1), (11, 1), (15, 1),     -- Programmation Web
(9, 2), (10, 2), (11, 2),              -- Bases de Donnees
(9, 3), (10, 3),                       -- Algorithmique Avancee (COMPLET : 2/2)
(9, 8), (15, 8),                       -- Intelligence Artificielle
-- ING1 -> cours ING1
(6, 4), (7, 4), (8, 4),                -- Mathematiques Discretes
(6, 7), (7, 7),                        -- Physique Quantique
-- ING3 -> cours ING3
(12, 5), (13, 5), (14, 5),             -- Systemes d'Exploitation
(12, 6), (13, 6);                      -- Reseaux

-- ---------- Notes ----------
-- Lea (9) dans Programmation Web (cours 1) : notes NON verrouillees -> demo saisie/modification.
...
-- Lea (9) dans Bases de Donnees (cours 2) : notes VERROUILLEES -> demo "note validee non modifiable".
(9, 2, 'CC1',    16.00, 1.00, 1),
(9, 2, 'Examen', 13.00, 2.00, 1),
-- Nathan (10) dans Programmation Web
(10, 1, 'CC1',    8.00, 1.00, 0),
(10, 1, 'CC2',   11.00, 1.00, 0),
(10, 1, 'Examen', 9.50, 2.00, 0),
-- Chloe (11) dans Programmation Web
(11, 1, 'CC1',   17.00, 1.00, 0),
(11, 1, 'CC2',   16.00, 1.00, 0);

-- ---------- Seances (emploi du temps) ----------
-- Emploi du temps coherent (aucun conflit dans le jeu de depart).
-- Pour DEMONTRER la detection de conflit en live : ajouter une seance ING2 le Lundi 08:30-09:30
-- (chevauche Programmation Web, meme promotion) OU en salle A101 le Lundi (meme salle).
INSERT INTO Seance (idCours, jour, heureDebut, heureFin, salle) VALUES
(1, 'Lundi',    '08:00:00', '10:00:00', 'A101'),   -- Programmation Web (ING2)
(2, 'Lundi',    '10:15:00', '12:15:00', 'A102'),   -- Bases de Donnees (ING2)
(3, 'Mardi',    '08:00:00', '10:00:00', 'A101'),   -- Algorithmique (ING2)
(8, 'Mercredi', '14:00:00', '16:00:00', 'B201'),   -- IA (ING2)
(4, 'Lundi',    '08:00:00', '10:00:00', 'C301'),   -- Maths Discretes (ING1)
(7, 'Jeudi',    '10:00:00', '12:00:00', 'C302'),   -- Physique Quantique (ING1)
(5, 'Jeudi',    '08:00:00', '10:00:00', 'D401'),   -- Systemes d'Exploitation (ING3)
(6, 'Vendredi', '10:00:00', '12:00:00', 'D401');   -- Reseaux (ING3)
